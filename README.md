...
### Prebuilt Images
Builds of the image are available on [Docker Hub](https://hub.docker.com/r/tiredofit/element) and is the recommended method of installation.

```bash
docker pull tiredofit/element:(imagetag)
```
